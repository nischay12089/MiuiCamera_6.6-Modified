...
.method public synthetic constructor <init>(Lcom/xiaomi/continuity/netbus/NetBusManager;LNp/b$f;Landroid/os/ResultReceiver;)V
    ...
    iput-object p1, p0, Lcom/xiaomi/continuity/netbus/y;->a:Lcom/xiaomi/continuity/netbus/NetBusManager;

    iput-object p2, p0, Lcom/xiaomi/continuity/netbus/y;->b:LNp/b$f;

    iput-object p3, p0, Lcom/xiaomi/continuity/netbus/y;->c:Landroid/os/ResultReceiver;
...
.method public final a(Landroid/os/IInterface;)V
    ...
    iget-object v0, p0, Lcom/xiaomi/continuity/netbus/y;->a:Lcom/xiaomi/continuity/netbus/NetBusManager;
    ...
    iget-object v2, p0, Lcom/xiaomi/continuity/netbus/y;->b:LNp/b$f;

    invoke-direct {v1, v2}, Lcom/xiaomi/continuity/netbus/NetBusManager$a;-><init>(Lcom/xiaomi/continuity/netbus/j;)V

    iget-object p0, p0, Lcom/xiaomi/continuity/netbus/y;->c:Landroid/os/ResultReceiver;

    const-string v2, "00070B2B"

    invoke-interface {p1, v0, v2, v1, p0}, Lcom/xiaomi/continuity/netbus/INetBusService;->unregisterDiscoveryListenerV2(Landroid/os/IBinder;Ljava/lang/String;Lcom/xiaomi/continuity/netbus/IDiscoveryListener;Landroid/os/ResultReceiver;)V
