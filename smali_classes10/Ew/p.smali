...
.method static constructor <clinit>()V
    ...
    sput-object v1, LEw/p;->e:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, LEw/p;->f:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
...
.method public constructor <init>(IZ)V
    ...
    iput p1, p0, LEw/p;->a:I

    iput-boolean p2, p0, LEw/p;->b:Z

    add-int/lit8 p2, p1, -0x1

    iput p2, p0, LEw/p;->c:I

    new-instance v0, Ljava/util/concurrent/atomic/AtomicReferenceArray;

    invoke-direct {v0, p1}, Ljava/util/concurrent/atomic/AtomicReferenceArray;-><init>(I)V

    iput-object v0, p0, LEw/p;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;
...
.method public final a(Ljava/lang/Runnable;)I
    ...
    :cond_2
    iget-object v11, p0, LEw/p;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget-boolean v4, p0, LEw/p;->b:Z
    ...
    invoke-virtual {p0}, LEw/p;->c()LEw/p;

    move-result-object p0

    iget-object v1, p0, LEw/p;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget v2, p0, LEw/p;->c:I
    ...
    instance-of v4, v3, LEw/p$a;

    if-eqz v4, :cond_6

    check-cast v3, LEw/p$a;

    iget v3, v3, LEw/p$a;->a:I
...
.method public final c()LEw/p;
    ...
    :goto_1
    sget-object p0, LEw/p;->e:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    iget v5, v1, LEw/p;->a:I

    mul-int/lit8 v5, v5, 0x2

    iget-boolean v6, v1, LEw/p;->b:Z

    invoke-direct {v4, v5, v6}, LEw/p;-><init>(IZ)V
    ...
    iget-object v7, v1, LEw/p;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    new-instance v7, LEw/p$a;

    invoke-direct {v7, v5}, LEw/p$a;-><init>(I)V

    :cond_2
    iget-object v8, v4, LEw/p;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget v9, v4, LEw/p;->c:I
...
.method public final d()Ljava/lang/Object;
    ...
    :cond_2
    iget-object v14, v1, LEw/p;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    invoke-virtual {v14, v12}, Ljava/util/concurrent/atomic/AtomicReferenceArray;->get(I)Ljava/lang/Object;

    move-result-object v15

    iget-boolean v5, v1, LEw/p;->b:Z
    ...
    invoke-virtual {v1}, LEw/p;->c()LEw/p;
    ...
    iget-object v0, v1, LEw/p;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget v1, v1, LEw/p;->c:I
