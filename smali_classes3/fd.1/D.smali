...
# direct methods
.method public constructor <init>(Lfd/e;ILfd/a;JJ)V
    .locals 0
    ...
    iput p2, p0, Lfd/D;->b:I

    iput-object p3, p0, Lfd/D;->c:Lfd/a;

    iput-wide p4, p0, Lfd/D;->d:J

    iput-wide p6, p0, Lfd/D;->e:J

    return-void
.end method

.method public static b(Lfd/w;Lgd/a;I)Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;
    .locals 4

    iget-object p1, p1, Lgd/a;->I:Lcom/google/android/gms/common/internal/zzj;
...
.method public final a(Lyd/v;)V
    ...
    iget-object v1, v0, Lfd/D;->a:Lfd/e;

    invoke-virtual {v1}, Lfd/e;->a()Z
    ...
    :cond_1
    iget-object v2, v0, Lfd/D;->a:Lfd/e;

    iget-object v3, v0, Lfd/D;->c:Lfd/a;

    iget-object v2, v2, Lfd/e;->j:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v3, v2, Lfd/w;->b:Led/a$e;

    instance-of v4, v3, Lgd/a;

    if-eqz v4, :cond_b

    check-cast v3, Lgd/a;

    iget-wide v4, v0, Lfd/D;->d:J
    ...
    iget-object v13, v3, Lgd/a;->I:Lcom/google/android/gms/common/internal/zzj;

    if-eqz v13, :cond_4

    invoke-virtual {v3}, Lgd/a;->b()Z

    move-result v13

    if-nez v13, :cond_4

    iget v4, v0, Lfd/D;->b:I

    invoke-static {v2, v3, v4}, Lfd/D;->b(Lfd/w;Lgd/a;I)Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;
    ...
    :goto_2
    iget-object v5, v0, Lfd/D;->a:Lfd/e;

    invoke-virtual/range {p1 .. p1}, Lyd/v;->f()Z
    ...
    :cond_7
    invoke-virtual {v8}, Lyd/v;->c()Ljava/lang/Exception;

    move-result-object v8

    instance-of v10, v8, Led/b;

    if-eqz v10, :cond_9

    check-cast v8, Led/b;

    iget-object v8, v8, Led/b;->a:Lcom/google/android/gms/common/api/Status;
    ...
    iget-wide v6, v0, Lfd/D;->d:J

    iget-wide v12, v0, Lfd/D;->e:J
    ...
    invoke-direct/range {v12 .. v17}, Lfd/E;-><init>(Lcom/google/android/gms/common/internal/MethodInvocation;IJI)V

    iget-object v0, v5, Lfd/e;->m:Lqd/f;
