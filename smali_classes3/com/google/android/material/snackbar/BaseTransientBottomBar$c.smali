...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, p2, v0, v0}, Lde/a;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    sget-object v1, Lzd/l;->SnackbarLayout:[I

    invoke-virtual {p1, p2, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v1

    sget v2, Lzd/l;->SnackbarLayout_elevation:I
    ...
    invoke-static {p0, v2}, Li0/E$d;->s(Landroid/view/View;F)V

    :cond_0
    sget v2, Lzd/l;->SnackbarLayout_animationMode:I
    ...
    sget v2, Lzd/l;->SnackbarLayout_shapeAppearance:I
    ...
    sget v2, Lzd/l;->SnackbarLayout_shapeAppearanceOverlay:I
    ...
    :cond_1
    invoke-static {p1, p2, v0, v0}, LWd/l;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)LWd/l$a;
    ...
    iput-object p2, p0, Lcom/google/android/material/snackbar/BaseTransientBottomBar$c;->b:LWd/l;

    :cond_2
    sget p2, Lzd/l;->SnackbarLayout_backgroundOverlayColorAlpha:I
    ...
    sget p2, Lzd/l;->SnackbarLayout_backgroundTint:I

    invoke-static {p1, v1, p2}, LSd/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    sget p1, Lzd/l;->SnackbarLayout_backgroundTintMode:I
    ...
    invoke-static {p1, v3}, LOd/o;->d(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    sget p1, Lzd/l;->SnackbarLayout_actionTextColorAlpha:I
    ...
    sget p1, Lzd/l;->SnackbarLayout_android_maxWidth:I
    ...
    sget p1, Lzd/l;->SnackbarLayout_maxActionInlineWidth:I
    ...
    sget p2, Lzd/b;->colorOnSurface:I

    invoke-virtual {p0}, Lcom/google/android/material/snackbar/BaseTransientBottomBar$c;->getBackgroundOverlayColorAlpha()F

    move-result v1

    invoke-static {p1, p0}, LCv/a;->b(ILandroid/view/View;)I

    move-result p1

    invoke-static {p2, p0}, LCv/a;->b(ILandroid/view/View;)I

    move-result p2

    invoke-static {p1, v1, p2}, LCv/a;->f(IFI)I

    move-result p1

    iget-object p2, p0, Lcom/google/android/material/snackbar/BaseTransientBottomBar$c;->b:LWd/l;
    ...
    invoke-direct {v0, p2}, LWd/g;-><init>(LWd/l;)V
    ...
    sget v1, Lzd/d;->mtrl_snackbar_background_corner_radius:I
