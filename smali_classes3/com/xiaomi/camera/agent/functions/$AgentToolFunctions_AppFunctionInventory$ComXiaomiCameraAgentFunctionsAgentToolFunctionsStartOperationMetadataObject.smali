...
.field private static final OPERATION_PARAMETER_METADATA:Lu/n;
...
.field private static final PARAMETER_METADATA_OPERATION_PRIMITIVE_DATA_TYPE:Lu/s;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/xiaomi/camera/agent/functions/$AgentToolFunctions_AppFunctionInventory$ComXiaomiCameraAgentFunctionsAgentToolFunctionsStartOperationMetadataObject;->PARAMETER_METADATA_OPERATION_PRIMITIVE_DATA_TYPE:Lu/s;
    ...
    sput-object v3, Lcom/xiaomi/camera/agent/functions/$AgentToolFunctions_AppFunctionInventory$ComXiaomiCameraAgentFunctionsAgentToolFunctionsStartOperationMetadataObject;->OPERATION_PARAMETER_METADATA:Lu/n;

    invoke-static {v3}, LBw/i;->N(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    sput-object v0, Lcom/xiaomi/camera/agent/functions/$AgentToolFunctions_AppFunctionInventory$ComXiaomiCameraAgentFunctionsAgentToolFunctionsStartOperationMetadataObject;->PARAMETER_METADATA_LIST:Ljava/util/List;
    ...
    sput-object v3, Lcom/xiaomi/camera/agent/functions/$AgentToolFunctions_AppFunctionInventory$ComXiaomiCameraAgentFunctionsAgentToolFunctionsStartOperationMetadataObject;->REFERENCE_RESPONSE_VALUE_TYPE:Lu/p;

    new-instance v1, Lu/q;

    invoke-direct {v1, v3, v2}, Lu/q;-><init>(Lu/f;Ljava/lang/String;)V

    sput-object v1, Lcom/xiaomi/camera/agent/functions/$AgentToolFunctions_AppFunctionInventory$ComXiaomiCameraAgentFunctionsAgentToolFunctionsStartOperationMetadataObject;->RESPONSE_METADATA:Lu/q;

    new-instance v2, Lu/u;

    sget-object v3, Lcom/xiaomi/camera/agent/functions/$AgentToolFunctions_AppFunctionInventory$ComXiaomiCameraAgentFunctionsAgentToolFunctionsStartOperationMetadataObject;->SCHEMA_METADATA:Lu/r;

    const-string v4, "com.xiaomi.camera.agent.functions.AgentToolFunctions#startOperation"

    invoke-direct {v2, v4, v3, v0, v1}, Lu/u;-><init>(Ljava/lang/String;Lu/r;Ljava/util/List;Lu/q;)V

    sput-object v2, Lcom/xiaomi/camera/agent/functions/$AgentToolFunctions_AppFunctionInventory$ComXiaomiCameraAgentFunctionsAgentToolFunctionsStartOperationMetadataObject;->APP_FUNCTION_METADATA:Lu/u;
...
.method public final getAPP_FUNCTION_METADATA()Lu/u;
    ...
    sget-object p0, Lcom/xiaomi/camera/agent/functions/$AgentToolFunctions_AppFunctionInventory$ComXiaomiCameraAgentFunctionsAgentToolFunctionsStartOperationMetadataObject;->APP_FUNCTION_METADATA:Lu/u;
