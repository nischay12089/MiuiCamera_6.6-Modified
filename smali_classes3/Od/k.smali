...
.method static constructor <clinit>()V
    ...
    sget v0, Lzd/b;->colorPrimary:I

    filled-new-array {v0}, [I

    move-result-object v0

    sput-object v0, LOd/k;->a:[I

    sget v0, Lzd/b;->colorPrimaryVariant:I

    filled-new-array {v0}, [I

    move-result-object v0

    sput-object v0, LOd/k;->b:[I
...
.method public static a(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    sget-object v0, Lzd/l;->ThemeEnforcement:[I

    invoke-virtual {p0, p1, v0, p2, p3}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Lzd/l;->ThemeEnforcement_enforceMaterialTheme:I
    ...
    sget p3, Lzd/b;->isMaterialTheme:I
    ...
    :cond_0
    sget-object p1, LOd/k;->b:[I

    const-string p2, "Theme.MaterialComponents"

    invoke-static {p0, p1, p2}, LOd/k;->c(Landroid/content/Context;[ILjava/lang/String;)V

    :cond_1
    sget-object p1, LOd/k;->a:[I
...
.method public static varargs b(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)V
    ...
    sget v1, Lzd/l;->ThemeEnforcement_enforceTextAppearance:I
    ...
    sget p0, Lzd/l;->ThemeEnforcement_android_textAppearance:I
...
.method public static varargs d(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;
    ...
    invoke-static {p0, p1, p3, p4}, LOd/k;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    invoke-static/range {p0 .. p5}, LOd/k;->b(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)V
