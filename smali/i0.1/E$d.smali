...
.method public static b(Landroid/view/View;Li0/f0;Landroid/graphics/Rect;)Li0/f0;
    .locals 1
...
.method public static j(Landroid/view/View;)Li0/f0;
    .locals 4

    sget-boolean v0, Li0/f0$a;->d:Z
    ...
    :try_start_0
    sget-object v1, Li0/f0$a;->a:Ljava/lang/reflect/Field;
    ...
    sget-object v1, Li0/f0$a;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v2, Li0/f0$a;->c:Ljava/lang/reflect/Field;
    ...
    new-instance v2, Li0/f0$c;

    invoke-direct {v2}, Li0/f0$c;-><init>()V

    goto :goto_0

    :cond_1
    new-instance v2, Li0/f0$b;

    invoke-direct {v2}, Li0/f0$b;-><init>()V

    :goto_0
    invoke-static {v1}, LZ/d;->c(Landroid/graphics/Rect;)LZ/d;

    move-result-object v1

    invoke-virtual {v2, v1}, Li0/f0$b;->e(LZ/d;)V

    invoke-static {v0}, LZ/d;->c(Landroid/graphics/Rect;)LZ/d;

    move-result-object v0

    invoke-virtual {v2, v0}, Li0/f0$b;->g(LZ/d;)V

    invoke-virtual {v2}, Li0/f0$b;->b()Li0/f0;
...
.method public static u(Landroid/view/View;Li0/r;)V
    .locals 2
    ...
    :cond_1
    new-instance v0, Li0/E$d$a;

    invoke-direct {v0, p0, p1}, Li0/E$d$a;-><init>(Landroid/view/View;Li0/r;)V
