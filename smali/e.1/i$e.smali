...
.method public constructor <init>(Le/i;)V
    ...
    iput-object p1, p0, Le/i$e;->h:Le/i;
...
.method public final b(ILh/a;Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Le/i$e;->h:Le/i;

    invoke-virtual {p2, v1, p3}, Lh/a;->b(Landroid/content/Context;Ljava/lang/Object;)Lh/a$a;
    ...
    new-instance p3, LOt/x;

    const/4 v1, 0x1

    invoke-direct {p3, p1, v1, p0, v0}, LOt/x;-><init>(IILjava/lang/Object;Ljava/lang/Object;)V
    ...
    :cond_a
    instance-of p2, v1, LW/a$d;

    if-eqz p2, :cond_b

    move-object p2, v1

    check-cast p2, LW/a$d;

    :cond_b
    invoke-static {v1, p0, p1}, LW/a$a;->b(Landroid/app/Activity;[Ljava/lang/String;I)V
    ...
    :try_start_1
    invoke-virtual/range {v1 .. v8}, Le/i;->startIntentSenderForResult(Landroid/content/IntentSender;ILandroid/content/Intent;IIILandroid/os/Bundle;)V
    :try_end_1
    ...
    new-instance p3, LOt/y;

    const/4 v0, 0x1

    invoke-direct {p3, v3, v0, p0, p1}, LOt/y;-><init>(IILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, p2, v3, v8}, Le/i;->startActivityForResult(Landroid/content/Intent;ILandroid/os/Bundle;)V
