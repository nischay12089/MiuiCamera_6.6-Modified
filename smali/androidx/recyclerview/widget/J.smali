...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/J;->mScrollListener:Landroidx/recyclerview/widget/RecyclerView$s;
...
.method private destroyCallbacks()V
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/J;->mScrollListener:Landroidx/recyclerview/widget/RecyclerView$s;
...
.method private snapFromFling(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;II)Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/J;->createScroller(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroidx/recyclerview/widget/RecyclerView$x;
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Landroidx/recyclerview/widget/J;->findTargetSnapPosition(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;II)I
...
.method public attachToRecyclerView(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    invoke-direct {p0}, Landroidx/recyclerview/widget/J;->destroyCallbacks()V
    ...
    invoke-direct {p0}, Landroidx/recyclerview/widget/J;->setupCallbacks()V
    ...
    iput-object p1, p0, Landroidx/recyclerview/widget/J;->mGravityScroller:Landroid/widget/Scroller;
...
.method public calculateScrollDistance(II)[I
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/J;->mGravityScroller:Landroid/widget/Scroller;
    ...
    iget-object p1, p0, Landroidx/recyclerview/widget/J;->mGravityScroller:Landroid/widget/Scroller;

    invoke-virtual {p1}, Landroid/widget/Scroller;->getFinalX()I

    move-result p1

    iget-object p0, p0, Landroidx/recyclerview/widget/J;->mGravityScroller:Landroid/widget/Scroller;
...
.method public createScroller(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroidx/recyclerview/widget/RecyclerView$x;
    ...
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/J;->createSnapScroller(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroidx/recyclerview/widget/v;
...
.method public createSnapScroller(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroidx/recyclerview/widget/v;
    .locals 1
    ...
    invoke-direct {p1, p0, v0}, Landroidx/recyclerview/widget/J$b;-><init>(Landroidx/recyclerview/widget/J;Landroid/content/Context;)V
...
.method public onFling(II)Z
    ...
    :cond_2
    invoke-direct {p0, v0, p1, p2}, Landroidx/recyclerview/widget/J;->snapFromFling(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;II)Z
...
.method public snapToTargetExistingView()V
    ...
    :cond_2
    invoke-virtual {p0, v0, v1}, Landroidx/recyclerview/widget/J;->calculateDistanceToFinalSnap(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;Landroid/view/View;)[I
